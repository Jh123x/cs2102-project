...
class ZRegisterSessionTest(BaseTest, unittest.TestCase):
    ...
    def setup_course_offering(self):
        ...
        self.course_offering = self._add_course_offering('2021-01-21', 10, [('2021-06-21', 9, 1)], '2021-05-31', 20, self.course_id, self.admin_id)
    ...
    def test_valid_registration_redeems(self):
        ...
        after_redemptions = self.execute_query(get_redeem_left_q)[0][0]
        assert before_redemptions - 1 == after_redemptions, "The number of redemptions should have decremented by 1"
