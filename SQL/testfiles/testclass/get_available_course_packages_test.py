...
class ZGetAvailableCoursePackages(BaseTest, unittest.TestCase):
    ...
    def test_all_package_avail(self):
        ...
        expected =set((('(\"Best package\",10,2023-05-06,200.01)',), ('(\"Best package2\",10,2023-05-06,200.01)',)))
        assert set(res) == expected, f'\nOutput:   {res}\nExpected: {expected}'
    ...
    def test_some_package_avail(self):
        ...
        q = f"INSERT INTO CoursePackages VALUES (3, 'Best Pkg', 5, '2020-04-01', '2021-04-01', 20)"
        ...
        assert len(res) == 1, f"There should be 1 course packages available {res}"
